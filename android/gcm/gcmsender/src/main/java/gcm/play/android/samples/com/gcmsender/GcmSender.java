...
public class GcmSender {
    ...
    public static final String API_KEY = "AIzaSyCXqFuWnwM0erzfis_WRG1aMjzV3UmsglU";

    public static void main(String[] args) {
        if (args.length < 1 || args.length > 2 || args[0] == null) {
            System.err.println("usage: ./gradlew run -Pmsg=\"MESSAGE\" [-Pto=\"DEVICE_TOKEN\"]");
            System.err.println("");
            System.err.println("Specify a test message to broadcast via 11GCM. If a device's GCM registration token is\n" +
